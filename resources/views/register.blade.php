...
<body>
    <div class="main d-flex flex-column justify-content-center align-items-center">
        ...
        @endif
        @if (session('status'))
            <div class="alert alert-success" style="width: 28rem; role="alert">
                {{session('status') }}
            </div>
        @endif
        <div class="card">
            <div class="card-body p-5 " style="width: 28rem; ">
                <p class="text-center fs-3 fw-semibold">Sign Up</p>
                <form method="post" action="">
                    ...
                    <div class="mb-3">
                        ...
                        <button type="submit" class="mb-3 btn btn-primary form-control">Register</button>
